...
<html>
<div class="header" style="position: absolute; left:0px;top:0; width:100%;height:40px; overflow:hidden; background:#ED0000; z-index:10;">
<h3 style="position: absolute; left:250px; width:170px; line-height:35px; color:white;">헤더</h3>
</div>
...
<div style="border: 1px solid #ABABAB; position:absolute; top:50px; left:100px; width:100px; height:100px; ">사진들어갈공간</div>
<label style="position:absolute; top:50px; left:230px; width:200px; height:25px;">상품명 :</label>
<div style="border: 1px solid #ABABAB; position:absolute; top:50px; left:300px; width:150px; height:25px; ">상품명DB</div>
<label style="position:absolute; top:75px; left:230px; width:200px; height:25px;">사이즈 :</label>
<div style="border: 1px solid #ABABAB; position:absolute; top:75px; left:300px; width:150px; height:25px; ">사이즈DB</div>
<label style="position:absolute; top:100px; left:230px; width:200px; height:25px;">색상 :</label>
<div style="border: 1px solid #ABABAB; position:absolute; top:100px; left:300px; width:150px; height:25px; ">색상DB</div>
<label style="position:absolute; top:125px; left:230px; width:200px; height:25px;">구매날짜 :</label>
<div style="border: 1px solid #ABABAB; position:absolute; top:125px; left:300px; width:150px; height:25px; ">구매날짜DB</div>
<div style="border: 1px solid #ABABAB; position:absolute; top:200px; left:120px; width:80px; height:25px; ">고객명DB</div>
...
<input type="text" style="position:absolute; top:70px; left:50px; width:450px;height:30px;">
<label style="position:absolute; top:120px; left:50px;">리뷰 작성란</label>
<input type="text" style="position:absolute; top:150px; left:50px; width:450px;height:100px;">
</div>
<div class="bottom" style="position: absolute; border-bottom:1px solid #ABABAB;  top:680px;left:0px;width:100%; height:1100px;">
...
<div id="large_img1" class="border border-success" style="position: absolute; border:1px solid #ABABAB;top:100px; left:120px; width:300px;height:900px;"></div>
</div>
</div>
