...
public class User_OrdersDao {
	public ArrayList<UserOrderlistVo> OrderList(int startRow, int endRow, String field, String id, String startdate,
		...
		if (field == null || field.equals("")) {
			sql = "select * from (select o.orid, o.ordate, o.ordelivery, o.orcomplete, o.orcancle, od.odcolor, od.odsize, od.odcount, p.pimage2, p.pprice, s.sname, od.odid, p.pid , s.sid "
